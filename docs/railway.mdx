...
Deploy Culturabuilder on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/culturabuilder-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/culturabuilder` — Control UI

## What you get

- Hosted Culturabuilder Gateway + Control UI
...
- `CULTURABUILDER_STATE_DIR=/data/.culturabuilder` (recommended)
- `CULTURABUILDER_WORKSPACE_DIR=/data/workspace` (recommended)
- `CULTURABUILDER_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Culturabuilder state + workspace so you can migrate to another host without losing config or memory.
