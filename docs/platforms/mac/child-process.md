...
service via the external `culturabuilder` CLI (no embedded runtime). This gives you
...
- The app installs a per‑user LaunchAgent labeled `com.culturabuilder.gateway`
