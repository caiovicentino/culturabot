...
read_when:
  - You want Culturabuilder to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Culturabuilder to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`culturabuilder onboard`) and `culturabuilder channels add` list optional channel plugins.
...
```bash
culturabuilder plugins install @culturabuilder/nostr
```

Use a local checkout (dev workflows):

```bash
culturabuilder plugins install --link <path-to-culturabuilder>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "culturabuilder",
        "displayName": "Culturabuilder",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "culturabuilder@example.com",
        "lud16": "culturabuilder@example.com"
      }
    }
  }
}
