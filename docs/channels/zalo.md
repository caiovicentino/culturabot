...
- Install via CLI: `culturabuilder plugins install @culturabuilder/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `culturabuilder plugins install ./extensions/zalo`
   - From npm (if published): `culturabuilder plugins install @culturabuilder/zalo`
...
- Approve via:
  - `culturabuilder pairing list zalo`
  - `culturabuilder pairing approve zalo <CODE>`
...
- Example: `culturabuilder message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `culturabuilder channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `culturabuilder logs --follow`
