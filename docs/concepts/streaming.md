...
Culturabuilder has two separate “streaming” layers:
...
When block streaming is enabled, Culturabuilder can **merge consecutive block chunks**
...
When draft streaming is active, Culturabuilder disables block streaming for that reply to avoid double-streaming.
