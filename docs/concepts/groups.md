...
Culturabuilder treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)
Culturabuilder “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Culturabuilder can see that group and respond there.

Default behavior:
- Groups are restricted (`groupPolicy: "allowlist"`).
- Replies require a mention unless you explicitly disable mention gating.

Translation: allowlisted senders can trigger Culturabuilder by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@clawd", "culturabuilder", "\\+15555550123"],
          historyLimit: 50
        }
      }
    ]
