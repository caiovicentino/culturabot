...
read_when:
  - You want to understand what “context” means in Culturabuilder
  - You are debugging why the model “knows” something (or forgot it)
  - You want to reduce context overhead (/context, /status, /compact)
---
# Context

“Context” is **everything Culturabuilder sends to the model for a run**. It is bounded by the model’s **context window** (token limit).

Beginner mental model:
- **System prompt** (Culturabuilder-built): rules, tools, skills list, time/runtime, and injected workspace files.
...
## How Culturabuilder builds the system prompt

The system prompt is **Culturabuilder-owned** and rebuilt each run. It includes:
...
By default, Culturabuilder injects a fixed set of workspace files (if present):
- `AGENTS.md`
- `SOUL.md`
- `TOOLS.md`
- `IDENTITY.md`
