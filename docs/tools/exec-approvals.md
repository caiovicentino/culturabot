...
- **gateway host** → `culturabuilder` process on the gateway machine
...
`~/.culturabuilder/exec-approvals.json` directly.

CLI: `culturabuilder approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
