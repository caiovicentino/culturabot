...
Culturabuilder controls a **dedicated Chrome profile** (named `clawd`, orange‑tinted UI). This is separate from your daily browser profile.
...
culturabuilder browser open https://x.com
```
...
```bash
culturabuilder browser open https://x.com --browser-profile clawd --target host
```
