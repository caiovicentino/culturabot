...
summary: Machine-checked security models for Culturabuilder’s highest-risk paths.
permalink: /security/formal-verification/
---

# Formal Verification (Security Models)

This page tracks Culturabuilder’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Culturabuilder enforces its
...
**What this is not (yet):** a proof that “Culturabuilder is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/culturabuilder-formal-models](https://github.com/vignesh07/culturabuilder-formal-models).
...
```bash
git clone https://github.com/vignesh07/culturabuilder-formal-models
cd culturabuilder-formal-models
