...
read_when:
  - You are building a Culturabuilder plugin
  - You need to ship a plugin config schema or debug plugin validation errors
---
# Plugin manifest (culturabuilder.plugin.json)

Every plugin **must** ship a `culturabuilder.plugin.json` file in the **plugin root**.
Culturabuilder uses this manifest to validate configuration **without executing plugin
