...
read_when:
  - You want to place an outbound voice call from Culturabuilder
  - You are configuring or developing the voice-call plugin
---

# Voice Call (plugin)

Voice calls for Culturabuilder via a plugin. Supports outbound notifications and
...
- Use `culturabuilder voicecall ...` or the `voice_call` tool
...
```bash
culturabuilder plugins install ./extensions/voice-call
