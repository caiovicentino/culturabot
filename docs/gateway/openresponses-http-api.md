...
Culturabuilder’s Gateway can serve an OpenResponses-compatible `POST /v1/responses` endpoint.
...
`culturabuilder agent`), so routing/permissions/config match your Gateway.
