...
You can point Culturabuilder at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Culturabuilder
...
- [Anthropic provider](/providers/anthropic) - Native Culturabuilder integration with Claude setup-token or API keys
