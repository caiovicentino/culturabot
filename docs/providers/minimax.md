---
summary: "Use MiniMax M2.1 in Culturabuilder"
read_when:
  - You want MiniMax models in Culturabuilder
...
Configure manually via `culturabuilder.json`:
...
- Use `culturabuilder models list` and `culturabuilder models set minimax/MiniMax-M2.1` to switch.
...
- Running `culturabuilder configure` and selecting **MiniMax M2.1**, or
