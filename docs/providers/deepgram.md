...
Deepgram is a speech-to-text API. In Culturabuilder it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Culturabuilder uploads the audio file to Deepgram and injects the transcript
