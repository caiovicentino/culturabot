---
summary: "Model providers (LLMs) supported by Culturabuilder"
read_when:
...
Culturabuilder can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `culturabuilder onboard`).
