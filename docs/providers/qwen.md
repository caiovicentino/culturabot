---
summary: "Use Qwen OAuth (free tier) in Culturabuilder"
read_when:
  - You want to use Qwen with Culturabuilder
...
```bash
culturabuilder models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Culturabuilder will sync credentials
