...
Culturabuilder defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, Culturabuilder inspects the OS preference (macOS/Windows)
