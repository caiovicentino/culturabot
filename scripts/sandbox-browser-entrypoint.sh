...
export DISPLAY=:1
export HOME=/tmp/culturabuilder-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${CULTURABUILDER_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${CULTURABUILDER_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${CULTURABUILDER_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${CULTURABUILDER_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${CULTURABUILDER_BROWSER_HEADLESS:-0}"
