...
#
# Output:
# - dist/Culturabuilder.app
# - dist/Culturabuilder-<version>.zip
# - dist/Culturabuilder-<version>.dmg
...
APP="$ROOT_DIR/dist/Culturabuilder.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Culturabuilder-$VERSION.zip"
DMG="$ROOT_DIR/dist/Culturabuilder-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Culturabuilder-$VERSION.notary.zip"
