...
if [[ -z "$version_content" ]]; then
  echo "<h2>Culturabuilder $VERSION</h2>"
  echo "<p>Latest Culturabuilder update.</p>"
  echo "<p><a href=\"https://github.com/culturabuilder/culturabuilder/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
