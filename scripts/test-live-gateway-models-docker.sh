...
docker run --rm -t \
  ...
  -e CULTURABUILDER_LIVE_GATEWAY_MODELS="${CULTURABUILDER_LIVE_GATEWAY_MODELS:-all}" \
  -e CULTURABUILDER_LIVE_GATEWAY_PROVIDERS="${CULTURABUILDER_LIVE_GATEWAY_PROVIDERS:-}" \
  -e CULTURABUILDER_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${CULTURABUILDER_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}" \
