...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CulturabuilderConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CulturabuilderConfig; env: NodeJS.ProcessEnv }): {
  cfg: CulturabuilderConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
