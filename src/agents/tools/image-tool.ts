...
function resolveDefaultModelRef(cfg?: CulturabuilderConfig): {
  provider: string;
  model: string;
} {
  if (cfg) {
...
function pickMaxBytes(cfg?: CulturabuilderConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const effectiveCfg: CulturabuilderConfig | undefined = params.cfg
    ? {
        ...params.cfg,
        agents: {
          ...params.cfg.agents,
  ...
  await ensureCulturabuilderModelsJson(effectiveCfg, params.agentDir);
