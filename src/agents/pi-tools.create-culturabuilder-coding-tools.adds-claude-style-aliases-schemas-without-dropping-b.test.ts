...
describe("createCulturabuilderCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createCulturabuilderCodingTools({
      config,
    ...
    const anthropicTools = createCulturabuilderCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createCulturabuilderCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createCulturabuilderCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
