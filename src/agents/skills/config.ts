...
import type { CulturabuilderConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: CulturabuilderConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(
  config: CulturabuilderConfig | undefined,
  pathStr: string,
): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "culturabuilder-bundled";
}

export function resolveBundledAllowlist(config?: CulturabuilderConfig): string[] | undefined {
