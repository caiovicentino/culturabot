...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveCulturabuilderAgentDir() returns mainAgentDir
    process.env.CULTURABUILDER_STATE_DIR = tmpDir;
    process.env.CULTURABUILDER_AGENT_DIR = mainAgentDir;
