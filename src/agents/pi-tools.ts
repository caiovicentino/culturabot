...
function resolveExecConfig(cfg: CulturabuilderConfig | undefined) {
...
export function createCulturabuilderCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createCulturabuilderReadTool(freshReadTool)];
    }
