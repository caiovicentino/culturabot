...
const _MODELS_CONFIG: CulturabuilderConfig = {
  models: {
    providers: {
      "custom-proxy": {
  ...
  it("falls back to default baseUrl when token exchange fails", async () => {
    await withTempHome(async () => {
      ...
      try {
        ...
        await ensureCulturabuilderModelsJson({ models: { providers: {} } });
  ...
  it("uses agentDir override auth profiles for copilot injection", async () => {
    await withTempHome(async (home) => {
      ...
      try {
        ...
        await ensureCulturabuilderModelsJson({ models: { providers: {} } }, agentDir);
