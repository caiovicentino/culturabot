...
export const DEFAULT_SANDBOX_IMAGE = "culturabuilder-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "culturabuilder-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "culturabuilder-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "culturabuilder-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "culturabuilder-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".culturabuilder");
