...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies CulturabuilderConfig;

const _ensureModels = (cfg: CulturabuilderConfig, agentDir: string) =>
  ensureCulturabuilderModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/culturabuilder-sandbox",
      agentWorkspaceDir: "/tmp/culturabuilder-workspace",
      ...
      browser: {
        ...
        containerName: "culturabuilder-sbx-browser-test",
      },
