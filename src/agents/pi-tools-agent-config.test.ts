...
describe("Agent-specific tool filtering", () => {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createCulturabuilderCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createCulturabuilderCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createCulturabuilderCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createCulturabuilderCodingTools({
      config: cfg,
    ...
    const bobTools = createCulturabuilderCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createCulturabuilderCodingTools({
      config: cfg,
