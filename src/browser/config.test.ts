...
describe("browser config", () => {
  ...
  it("derives default ports from CULTURABUILDER_GATEWAY_PORT when unset", () => {
    const prev = process.env.CULTURABUILDER_GATEWAY_PORT;
    process.env.CULTURABUILDER_GATEWAY_PORT = "19001";
    try {
      const resolved = resolveBrowserConfig(undefined);
      ...
      if (prev === undefined) {
        ...
        process.env.CULTURABUILDER_GATEWAY_PORT = prev;
      }
    }
  });
