...
export function resolveTtsConfig(cfg: CulturabuilderConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.CULTURABUILDER_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: CulturabuilderConfig): string | undefined {
