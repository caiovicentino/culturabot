...
export const PLUGIN_MANIFEST_FILENAME = "culturabuilder.plugin.json";
...
// package.json "culturabuilder" metadata (used for onboarding/catalog)
...
export type CulturabuilderPackageManifest = {
  extensions?: string[];
...
): CulturabuilderPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.culturabuilder;
}
