...
import {
  ...
  type CulturabuilderPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @culturabuilder/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageCulturabuilder: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverCulturabuilderPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".culturabuilder", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
