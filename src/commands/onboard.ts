  ...
  if (normalizedOpts.nonInteractive && normalizedOpts.acceptRisk !== true) {
    runtime.error(
      [
        ...
        "Read: https://docs.culturabuilder.com/security",
        `Re-run with: ${formatCliCommand("culturabuilder onboard --non-interactive --accept-risk ...")}`,
      ].join("\n"),
    );
    runtime.exit(1);
    return;
  ...
  if (process.platform === "win32") {
    runtime.log(
      [
        ...
        "Guide: https://docs.culturabuilder.com/windows",
      ].join("\n"),
    );
  }
