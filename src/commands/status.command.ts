...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Culturabuilder status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("culturabuilder security audit")}`));
  runtime.log(
    theme.muted(`Deep probe: ${formatCliCommand("culturabuilder security audit --deep")}`),
  );
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.culturabuilder.com/faq");
  runtime.log("Troubleshooting: https://docs.culturabuilder.com/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("culturabuilder status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("culturabuilder logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("culturabuilder status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("culturabuilder gateway probe")}`);
  }
}
