...
export async function updateConfig(
  mutator: (cfg: CulturabuilderConfig) => CulturabuilderConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: CulturabuilderConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: CulturabuilderConfig): Set<string> {
