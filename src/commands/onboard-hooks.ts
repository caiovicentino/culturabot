...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.culturabuilder.com/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("culturabuilder hooks list")}`,
      `  ${formatCliCommand("culturabuilder hooks enable <name>")}`,
      `  ${formatCliCommand("culturabuilder hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
