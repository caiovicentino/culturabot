...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/culturabuilder when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "culturabuilder");
  ...
  it("flags ~/culturabuilder when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "culturabuilder");
