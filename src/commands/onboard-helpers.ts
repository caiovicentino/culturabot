...
export function summarizeExistingConfig(config: CulturabuilderConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.culturabuilder.com/gateway/remote",
    "https://docs.culturabuilder.com/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
