...
export function applyMinimaxProviderConfig(cfg: CulturabuilderConfig): CulturabuilderConfig {
...
export function applyMinimaxConfig(cfg: CulturabuilderConfig): CulturabuilderConfig {
