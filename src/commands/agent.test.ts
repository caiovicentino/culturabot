...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "culturabuilder-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<CulturabuilderConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<CulturabuilderConfig["telegram"]>>,
