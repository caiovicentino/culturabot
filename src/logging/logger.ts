...
export const DEFAULT_LOG_DIR = "/tmp/culturabuilder";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "culturabuilder.log"); // legacy single-file path

const LOG_PREFIX = "culturabuilder";
...
function resolveSettings(): ResolvedSettings {
  let cfg: CulturabuilderConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => CulturabuilderConfig;
      };
