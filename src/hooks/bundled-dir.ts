...
export function resolveBundledHooksDir(): string | undefined {
  const override = process.env.CULTURABUILDER_BUNDLED_HOOKS_DIR?.trim();
  ...
  // This path works when installed via npm: node_modules/culturabuilder/dist/hooks/bundled-dir.js
  try {
