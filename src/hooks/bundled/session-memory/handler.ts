...
const saveSessionToMemory: HookHandler = async (event) => {
  ...
  try {
    ...
    const cfg = context.cfg as CulturabuilderConfig | undefined;
    ...
    if (sessionFile) {
      ...
      if (sessionContent && cfg) {
        ...
        const culturabuilderRoot = path.resolve(
          path.dirname(import.meta.url.replace("file://", "")),
          "../..",
        );
        const slugGenPath = path.join(culturabuilderRoot, "llm-slug-generator.js");
