...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    CULTURABUILDER_PROFILE: profile,
    CULTURABUILDER_STATE_DIR: env.CULTURABUILDER_STATE_DIR,
    CULTURABUILDER_CONFIG_PATH: env.CULTURABUILDER_CONFIG_PATH,
    CULTURABUILDER_GATEWAY_PORT: String(port),
    CULTURABUILDER_GATEWAY_TOKEN: token,
    CULTURABUILDER_LAUNCHD_LABEL: resolvedLaunchdLabel,
    CULTURABUILDER_SYSTEMD_UNIT: systemdUnit,
    CULTURABUILDER_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    CULTURABUILDER_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    CULTURABUILDER_STATE_DIR: env.CULTURABUILDER_STATE_DIR,
    CULTURABUILDER_CONFIG_PATH: env.CULTURABUILDER_CONFIG_PATH,
    CULTURABUILDER_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    CULTURABUILDER_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    CULTURABUILDER_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    CULTURABUILDER_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    CULTURABUILDER_LOG_PREFIX: "node",
    CULTURABUILDER_SERVICE_MARKER: NODE_SERVICE_MARKER,
    CULTURABUILDER_SERVICE_KIND: NODE_SERVICE_KIND,
    CULTURABUILDER_SERVICE_VERSION: VERSION,
  };
}
