...
export const A2UI_PATH = "/__culturabuilder__/a2ui";
export const CANVAS_HOST_PATH = "/__culturabuilder__/canvas";
export const CANVAS_WS_PATH = "/__culturabuilder/ws";
...
(() => {
  ...
  const handlerNames = ["culturabuilderCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Culturabuilder = globalThis.Culturabuilder ?? {};
  globalThis.Culturabuilder.postMessage = postToNode;
  globalThis.Culturabuilder.sendUserAction = sendUserAction;
  globalThis.culturabuilderPostMessage = postToNode;
  globalThis.culturabuilderSendUserAction = sendUserAction;
  globalThis.culturabuilderPostMessage = postToNode;
  globalThis.culturabuilderSendUserAction = sendUserAction;
