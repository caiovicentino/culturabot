...
vi.mock("./culturabuilder-root.js", () => ({
...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "culturabuilder-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveCulturabuilderPackageRoot } = await import("./culturabuilder-root.js");
    ...
    vi.mocked(resolveCulturabuilderPackageRoot).mockResolvedValue("/opt/culturabuilder");
    vi.mocked(checkUpdateStatus).mockResolvedValue({
      root: "/opt/culturabuilder",
      installKind: "package",
      packageManager: "npm",
