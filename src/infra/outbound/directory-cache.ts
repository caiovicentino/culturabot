...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: CulturabuilderConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: CulturabuilderConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: CulturabuilderConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: CulturabuilderConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: CulturabuilderConfig): void {
