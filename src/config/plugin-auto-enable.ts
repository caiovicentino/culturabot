import type { CulturabuilderConfig } from "./config.js";
import {
  getChatChannelMeta,
  listChatChannels,
...
function isTelegramConfigured(cfg: CulturabuilderConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: CulturabuilderConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: CulturabuilderConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: CulturabuilderConfig): boolean {
...
function isIMessageConfigured(cfg: CulturabuilderConfig): boolean {
...
function isWhatsAppConfigured(cfg: CulturabuilderConfig): boolean {
...
function isGenericChannelConfigured(cfg: CulturabuilderConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: CulturabuilderConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: CulturabuilderConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: CulturabuilderConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: CulturabuilderConfig, pluginId: string): boolean {
...
function enablePluginEntry(cfg: CulturabuilderConfig, pluginId: string): CulturabuilderConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
