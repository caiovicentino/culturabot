...
function setDiscordDmPolicy(cfg: CulturabuilderConfig, dmPolicy: DmPolicy) {
  const allowFrom =
...
function setDiscordAllowFrom(cfg: CulturabuilderConfig, allowFrom: string[]): CulturabuilderConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
