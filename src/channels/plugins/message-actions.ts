...
export function listChannelMessageActions(cfg: CulturabuilderConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: CulturabuilderConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: CulturabuilderConfig): boolean {
  for (const plugin of listChannelPlugins()) {
