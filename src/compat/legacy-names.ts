export const LEGACY_PROJECT_NAME = "culturabuilder" as const;
...
export const LEGACY_MACOS_APP_SOURCES_DIR = "apps/macos/Sources/Culturabuilder" as const;

export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/Culturabuilder" as const;
