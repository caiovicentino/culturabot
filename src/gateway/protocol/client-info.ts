export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "culturabuilder-control-ui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "culturabuilder-macos",
  IOS_APP: "culturabuilder-ios",
  ANDROID_APP: "culturabuilder-android",
  NODE_HOST: "node-host",
  TEST: "test",
  FINGERPRINT: "fingerprint",
  PROBE: "culturabuilder-probe",
} as const;
