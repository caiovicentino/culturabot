...
import { type CulturabuilderConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: CulturabuilderConfig): string[] {
...
export function listAgentsForGateway(cfg: CulturabuilderConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: CulturabuilderConfig): string {
...
function resolveSessionStoreAgentId(cfg: CulturabuilderConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: CulturabuilderConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: CulturabuilderConfig): GatewaySessionsDefaults {
