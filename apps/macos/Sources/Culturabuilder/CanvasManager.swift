...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "com.culturabuilder", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Culturabuilder/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__culturabuilder__/a2ui/").absoluteString + "?platform=macos"
    }
