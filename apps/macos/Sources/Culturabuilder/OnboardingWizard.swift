...
private let onboardingWizardLogger = Logger(subsystem: "com.culturabuilder", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between CulturabuilderProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = CulturabuilderProtocol.AnyCodable
