...
enum LaunchAgentManager {
    private static let legacyLaunchdLabels = [
        "com.steipete.culturabuilder",
        "com.culturabuilder.mac",
    ]
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/com.culturabuilder.mac.plist")
    }
    ...
    private static func writePlist(bundlePath: String) {
        ...
        <dict>
          <key>Label</key>
          <string>com.culturabuilder.mac</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/Culturabuilder</string>
          </array>
