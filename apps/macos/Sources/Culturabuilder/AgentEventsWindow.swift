...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: CulturabuilderProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": CulturabuilderProtocol.AnyCodable("start"),
                "name": CulturabuilderProtocol.AnyCodable("bash"),
            ],
            summary: nil)
