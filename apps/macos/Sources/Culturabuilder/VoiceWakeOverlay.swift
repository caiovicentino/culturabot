...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.culturabuilder", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Culturabuilder windows, but below the system’s pop-up menus.
