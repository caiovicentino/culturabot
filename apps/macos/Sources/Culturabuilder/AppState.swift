...
final class AppState {
    ...
    var onboardingSeen: Bool {
        didSet { self.ifNotPreview { UserDefaults.standard.set(self.onboardingSeen, forKey: "culturabuilder.onboardingSeen") }
        }
    }

    var debugPaneEnabled: Bool {
        didSet {
            self.ifNotPreview { UserDefaults.standard.set(self.debugPaneEnabled, forKey: "culturabuilder.debugPaneEnabled") }
    ...
    init(preview: Bool = false) {
        ...
        let onboardingSeen = UserDefaults.standard.bool(forKey: "culturabuilder.onboardingSeen")
        self.isPaused = UserDefaults.standard.bool(forKey: pauseDefaultsKey)
        self.launchAtLogin = false
        self.onboardingSeen = onboardingSeen
        self.debugPaneEnabled = UserDefaults.standard.bool(forKey: "culturabuilder.debugPaneEnabled")
        ...
        let configRoot = CulturabuilderConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = CulturabuilderConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = CulturabuilderConfigFile.loadDict()
            ...
            CulturabuilderConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/culturabuilder"
        state.remoteCliPath = ""
        return state
    }
}
