...
enum UIStrings {
    static let welcomeTitle = "Welcome to Culturabuilder"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: CulturabuilderOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: CulturabuilderChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g culturabuilder@\(version)"
    }
