...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "com.culturabuilder", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return CulturabuilderConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - Culturabuilder Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.culturabuilder/culturabuilder.json
