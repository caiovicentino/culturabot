...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "com.culturabuilder", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        CulturabuilderPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        CulturabuilderPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
