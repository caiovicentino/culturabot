...
extension OnboardingView {
    static func exerciseForTesting() {
        ...
        let gateway = GatewayDiscoveryModel.DiscoveredGateway(
            ...
            sshPort: 2222,
            gatewayPort: 18789,
            cliPath: "/usr/local/bin/culturabuilder",
            stableID: "gateway-1",
            debugID: "gateway-1",
            isLocal: false)
        ...
        view.localGatewayProbe = LocalGatewayProbe(
            ...
            pid: 123,
            command: "culturabuilder-gateway",
            expected: true)
        view.showAdvancedConnection = true
        view.preferredGatewayID = gateway.stableID
        view.cliInstalled = true
        view.cliInstallLocation = "/usr/local/bin/culturabuilder"
        view.cliStatus = "Installed"
        view.workspacePath = "/tmp/culturabuilder"
