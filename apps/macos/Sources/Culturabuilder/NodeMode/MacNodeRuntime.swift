...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case CulturabuilderCameraCommand.snap.rawValue,
                 ...
                 CulturabuilderCameraCommand.list.rawValue:
                return try await self.handleCameraInvoke(req)
            case CulturabuilderLocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case CulturabuilderSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case CulturabuilderSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case CulturabuilderSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case CulturabuilderSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case CulturabuilderSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case CulturabuilderCanvasA2UICommand.push.rawValue,
             CulturabuilderCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleA2UIPush(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let command = req.command
        let messages: [CulturabuilderKit.AnyCodable]
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__culturabuilder__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func isA2UIReady(poll: Bool = false) async -> Bool {
        ...
        while true {
            do {
                ...
                (() => String(Boolean(globalThis.culturabuilderA2UI)))()
                """)
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(CulturabuilderSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(CulturabuilderSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: CulturabuilderSystemRunParams,
    ...
    private func handleSystemNotify(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(CulturabuilderSystemNotifyParams.self, from: req.paramsJSON)
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> CulturabuilderLocationMode {
    ...
    private static func errorResponse(
        ...
        code: CulturabuilderNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: CulturabuilderNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: CulturabuilderCanvasSnapshotFormat,
        maxWidth: Int?,
