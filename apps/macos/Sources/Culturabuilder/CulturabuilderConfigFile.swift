...
enum CulturabuilderConfigFile {
    private static let logger = Logger(subsystem: "com.culturabuilder", category: "config")

    static func url() -> URL {
        CulturabuilderPaths.configURL
    }

    static func stateDirURL() -> URL {
        CulturabuilderPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        CulturabuilderPaths.workspaceURL
    }
