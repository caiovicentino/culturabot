...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Culturabuilder token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: CulturabuilderOAuthStore.AnthropicOAuthStatus = CulturabuilderOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "com.culturabuilder", category: "anthropic-oauth")
...
enum CulturabuilderOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let culturabuilderOAuthDirEnv = "CULTURABUILDER_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Culturabuilder OAuth token file not found"
            case .unreadableFile: "Culturabuilder OAuth token file not readable"
            case .invalidJSON: "Culturabuilder OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Culturabuilder OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Culturabuilder OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.culturabuilderOAuthDirEnv]?
