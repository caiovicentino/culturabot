...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "com.culturabuilder", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: CulturabuilderPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = CulturabuilderPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.culturabuilderSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.culturabuilderSocketPath, privacy: .public)")
    }
...
@MainActor
private final class CulturabuilderPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "com.culturabuilder.peekaboo")
