...
/// Menu contents for the Culturabuilder menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Culturabuilder") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Culturabuilder Not Configured"
        case .remote:
            "Remote Culturabuilder Active"
        case .local:
            "Culturabuilder Active"
        }
    }
