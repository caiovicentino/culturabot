...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.culturabuilder", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.culturabuilder", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [CulturabuilderChatMessage] = messages.compactMap { item in
