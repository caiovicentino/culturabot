...
actor RemoteTunnelManager {
    ...
    private let logger = Logger(subsystem: "com.culturabuilder", category: "remote-tunnel")
    ...
    func controlTunnelPortIfRunning() async -> UInt16? {
        ...
        // If a previous Culturabuilder run already has an SSH listener on the expected port (common after restarts),
