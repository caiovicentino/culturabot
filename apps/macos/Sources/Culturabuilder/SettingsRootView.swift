...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .culturabuilderSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? CulturabuilderPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? CulturabuilderPaths.stateDirURL.path
...
extension Notification.Name {
    static let culturabuilderSelectSettingsTab = Notification.Name("culturabuilderSelectSettingsTab")
}
