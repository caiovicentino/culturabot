...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "com.culturabuilder", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".culturabuilder/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.culturabuilderCommand(
            subcommand: "gateway",
