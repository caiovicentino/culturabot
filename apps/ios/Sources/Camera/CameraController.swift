...
actor CameraController {
    ...
    func snap(params: CulturabuilderCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: CulturabuilderCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("culturabuilder-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("culturabuilder-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: CulturabuilderCameraFacing,
