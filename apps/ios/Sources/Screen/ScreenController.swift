...
final class ScreenController {
    ...
    /// Callback invoked when a culturabuilder:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = CulturabuilderKitResources.bundle
...
/// Handles navigation policy to intercept culturabuilder:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept culturabuilder:// deep links
        if url.scheme == "culturabuilder" {
