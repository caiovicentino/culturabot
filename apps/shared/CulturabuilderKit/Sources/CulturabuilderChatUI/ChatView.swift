...
@MainActor
public struct CulturabuilderChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: CulturabuilderChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                CulturabuilderChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [CulturabuilderChatMessage] {
        let base: [CulturabuilderChatMessage]
    ...
    private func mergeToolResults(in messages: [CulturabuilderChatMessage]) -> [CulturabuilderChatMessage] {
        ...
        for message in messages {
            ...
            let merged = CulturabuilderChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: CulturabuilderChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: CulturabuilderChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: CulturabuilderChatMessage) -> String {
