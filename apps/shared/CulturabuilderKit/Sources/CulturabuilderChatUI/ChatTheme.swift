...
enum CulturabuilderChatTheme {
    ...
    static let assistantBubbleDynamicNSColor = NSColor(
        name: NSColor.Name("CulturabuilderChatTheme.assistantBubble"),
        dynamicProvider: resolvedAssistantBubbleColor(for:))

    static let onboardingAssistantBubbleDynamicNSColor = NSColor(
        name: NSColor.Name("CulturabuilderChatTheme.onboardingAssistantBubble"),
...
enum CulturabuilderPlatformImageFactory {
    static func image(_ image: CulturabuilderPlatformImage) -> Image {
        #if os(macOS)
        Image(nsImage: image)
        #else
        Image(uiImage: image)
