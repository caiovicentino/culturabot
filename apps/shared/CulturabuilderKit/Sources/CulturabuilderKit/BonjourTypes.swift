...
public enum CulturabuilderBonjour {
    // v0: internal-only, subject to rename.
    public static let gatewayServiceType = "_culturabuilder-gw._tcp"
    public static let gatewayServiceDomain = "local."
    public static let wideAreaGatewayServiceDomain = "culturabuilder.internal."
