...
public enum CulturabuilderCanvasA2UICommand: String, Codable, Sendable {
...
public struct CulturabuilderCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct CulturabuilderCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
