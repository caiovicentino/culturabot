...
object CulturabuilderCanvasA2UIAction {
  ...
  fun jsDispatchA2UIActionStatus(actionId: String, ok: Boolean, error: String?): String {
    ...
    return "window.dispatchEvent(new CustomEvent('culturabuilder:a2ui-action-status', { detail: { id: \"${idEscaped}\", ok: ${okLiteral}, error: \"${err}\" } }));"
  }
}
