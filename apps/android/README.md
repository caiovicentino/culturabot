## Culturabuilder Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_culturabuilder-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm culturabuilder gateway --port 18789 --verbose
```
