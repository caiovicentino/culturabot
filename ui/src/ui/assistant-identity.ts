...
declare global {
  interface Window {
    __CULTURABUILDER_ASSISTANT_NAME__?: string;
    __CULTURABUILDER_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__CULTURABUILDER_ASSISTANT_NAME__,
    avatar: window.__CULTURABUILDER_ASSISTANT_AVATAR__,
  });
}
