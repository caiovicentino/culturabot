...
Nostr DM channel plugin for Culturabuilder using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Culturabuilder. It enables your bot to:
...
# Configure culturabuilder to use local relay
