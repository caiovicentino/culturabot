...
import { removeAckReactionAfterReply, shouldAckReaction } from "culturabuilder/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/culturabuilder") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
