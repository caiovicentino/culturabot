...
export function extractMSTeamsPollVote(
  ...
  const pollId =
    readNestedString(value, ["culturabuilderPollId"]) ??
    readNestedString(value, ["pollId"]) ??
    readNestedString(value, ["culturabuilder", "pollId"]) ??
    readNestedString(value, ["culturabuilder", "poll", "id"]) ??
    readNestedString(value, ["data", "culturabuilderPollId"]) ??
    readNestedString(value, ["data", "pollId"]) ??
    readNestedString(value, ["data", "culturabuilder", "pollId"]);
    ...
    actions: [
      {
        ...
        title: "Vote",
        data: {
          culturabuilderPollId: pollId,
        },
        msteams: {
          type: "messageBack",
          text: "culturabuilder poll vote",
          displayText: "Vote recorded",
          value: { culturabuilderPollId: pollId },
        },
      },
    ],
  };
