...
function setMSTeamsDmPolicy(cfg: CulturabuilderConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: CulturabuilderConfig, allowFrom: string[]): CulturabuilderConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
