import type { ChannelOnboardingAdapter, CulturabuilderConfig, WizardPrompter } from "culturabuilder/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.culturabuilder.com/channels/mattermost",
    ].join("\n"),
...
export const mattermostOnboardingAdapter: ChannelOnboardingAdapter = {
  ...
  disable: (cfg: CulturabuilderConfig) => ({
    ...cfg,
    channels: {
      ...cfg.channels,
