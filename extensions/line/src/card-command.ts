import type { CulturabuilderPluginApi, LineChannelData, ReplyPayload } from "culturabuilder/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: CulturabuilderPluginApi): void {
  api.registerCommand({
    name: "card",
