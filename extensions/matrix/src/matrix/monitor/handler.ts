...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: typeof import("culturabuilder/plugin-sdk")["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    typeof import("culturabuilder/plugin-sdk")["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "Culturabuilder: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
