...
const tlonOutbound: ChannelOutboundAdapter = {
  ...
  sendText: async ({ cfg, to, text, accountId, replyToId, threadId }) => {
    const account = resolveTlonAccount(cfg as CulturabuilderConfig, accountId ?? undefined);
...
export const tlonPlugin: ChannelPlugin = {
  ...
  config: {
    listAccountIds: (cfg) => listTlonAccountIds(cfg as CulturabuilderConfig),
    resolveAccount: (cfg, accountId) => resolveTlonAccount(cfg as CulturabuilderConfig, accountId ?? undefined),
  ...
  setup: {
    ...
    validateInput: ({ cfg, accountId, input }) => {
      ...
      const resolved = resolveTlonAccount(cfg as CulturabuilderConfig, accountId ?? undefined);
