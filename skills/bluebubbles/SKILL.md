---
name: bluebubbles
description: Build or update the BlueBubbles external channel plugin for Culturabuilder (extension package, REST send/probe, webhook inbound).
---
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `culturabuilder/plugin-sdk` helpers.
